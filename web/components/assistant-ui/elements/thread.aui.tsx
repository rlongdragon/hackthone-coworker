  ...
  return (
    <ThreadPrimitive.Root
      ...
      style={{
        ...
        // translucent composer + backdrop blur on the footer = frosted glass
        ...
        >
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              ...
              !isEmpty &&
                "bg-background/55 sticky bottom-0 mt-auto rounded-t-(--composer-radius) backdrop-blur-md",
            )}
          >
